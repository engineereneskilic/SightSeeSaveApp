...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "gezgorkaydetApp")
    ...
    // kendi metodlarım
    func benihatirla(){
        let kullanici : String? = UserDefaults.standard.string(forKey: "girisyapildimi")
        ...
        if(kullanici != nil){
            ...
            let navigationController = board.instantiateViewController(withIdentifier: "navigasyonVC") as! UINavigationController
